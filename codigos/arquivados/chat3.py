...
if __name__ == '__main__':
    ...
    ip_peer = input("\nDefina o IP do peer para enviar mensagens: ")
    porta_peer = int(input("Defina a porta do peer para enviar mensagens: "))
    ...
    while True:
        ...
        print("2. Modificar IP e porta do peer")
        print("3. Sair")
        ...
        if escolha == '1':
            ...
            print("\nDigite os novos dados do peer:")
            ip_peer = input("  Novo IP do peer: ")
            porta_peer = int(input("  Nova porta do peer: "))
            print(f"Peer atualizado para {ip_peer}:{porta_peer}")
